...
export default function Home() {
  return (
    <main className="landing-page bg-[#f7f9ff] text-[#17233f] overflow-hidden">
      ...
      <nav className="landing-nav fixed left-1/2 top-3 z-50 w-[84%] max-w-[22rem] -translate-x-1/2 rounded-full border border-[#d8e1f0] bg-white/80 px-3 py-2 shadow-[0_8px_30px_rgba(23,35,63,0.08)] backdrop-blur-xl md:top-4 md:w-fit md:max-w-none md:px-4">
