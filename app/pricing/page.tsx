  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen font-sans selection:bg-primary selection:text-white flex flex-col">
      ...
      <div className="pt-32 pb-12 px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-500 leading-relaxed font-medium" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="border-2 border-primary bg-white rounded-[2rem] p-8 md:p-12 shadow-xl shadow-blue-500/5 flex flex-col">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-1">Beta Plan</h3>
              <p className="text-xs font-bold text-primary tracking-widest uppercase">FULL ACCESS • ALL FEATURES</p>
            </div>
            <div className="text-left md:text-right">
              <span className="text-5xl font-fraunces font-bold text-primary block mb-1">₦9,000</span>
              <span className="text-gray-500 text-sm font-medium">per month</span>
            </div>
          </div>

          <p className="text-gray-600 leading-relaxed font-medium mb-8 pb-8 border-b border-gray-100">
          ...
          <p className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-6">WHAT'S INCLUDED</p>
          ...
          <Link href="/waitlist" className="w-full md:w-2/3 mx-auto py-4 bg-primary text-white font-bold rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center shadow-lg shadow-blue-500/30">
            Join the waitlist
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white py-20 md:py-32 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            <div className="text-primary text-xs font-bold uppercase tracking-widest mb-4">FOUNDATION PLAN</div>
            ...
            <p className="text-gray-500 font-medium">No surprises. Here's exactly what you get from day one.</p>
          </div>
