      ...
      <div className="w-full max-w-6xl bg-white shadow-2xl rounded-3xl overflow-hidden flex min-h-[600px] lg:min-h-[700px] border border-gray-100">
        ...
        <div className="hidden md:flex w-1/2 bg-primary p-12 flex-col justify-between relative text-white">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none p-20">
            {leftContent?.icon ? (
              <div className="opacity-20 transform scale-[3] blur-[1px]">
                {leftContent.icon}
              </div>
            ) : (
              <Image 
          ...
          <div className="relative z-10 mt-auto">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl">
              <h2 className="text-xl font-bold text-white mb-2 uppercase tracking-tight">
                {leftContent?.title || "Automate your business records. Stay tax-ready."}
              </h2>
              <p className="text-blue-100 text-sm leading-relaxed opacity-90 font-medium">
                {leftContent?.description || "Track income and expenses automatically, generate clean reports, and prepare for tax filing without spreadsheets."}
              </p>
            </div>
          </div>
        </div>
