...
export default function Hero() {
  ...
  useEffect(() => {
    (async function () {
      ...
      cal("ui", {
        styles: { branding: { brandColor: "#4F75FF" } },
  ...
  return (
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28 bg-[#FFFFFF] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        {/* --- BETA BADGE --- */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50/50 border border-blue-100 mb-6" data-aos="fade-up">
